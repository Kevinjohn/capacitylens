...
2. A popover (`data-testid="allocation-popover"`) appears showing: the task/label, **project · client** (e.g. *Brand Themes · Globex*), the **date range**, **Nh/day**, the **status**, and a note line if the allocation has one.
