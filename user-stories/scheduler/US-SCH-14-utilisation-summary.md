...
5. Click the **week-range toggle** through **1w → 2w → 4w → 6w → 8w**. The top-left label updates to **"Utilisation · 1w/2w/4w/6w/8w"** and the **overall %** changes at each step — it now reflects the work in _exactly_ the visible span. With the seed (work concentrated in the opening week), a narrow span reads busier than a wide one that folds in the quieter later weeks.
