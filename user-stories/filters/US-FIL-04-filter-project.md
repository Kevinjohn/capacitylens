...
- ✅ Choosing **Brand Themes** collapses the view to exactly that project's work — the _Brand System_ bar; allocations from other projects (e.g. _Project Lightning_ activities) are hidden, along with the resources that have no Brand Themes work.
