...
on for the company — showing each external in a neutral band at the bottom of the schedule and an
**External** section under the Resources tab for every member using that account.
