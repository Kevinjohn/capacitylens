...
**Sections shown (no query):** Actions ("Go to today"), Pages (the 11 fixed application routes; 10 — no
Disciplines — when the company turns disciplines off; not filtered by per-role sidebar visibility such
as Overview access).
