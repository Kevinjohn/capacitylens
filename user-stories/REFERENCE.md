...
both ends. The ordered week-column headers in Overview are the deliberate exception: neighbouring
columns provide the calendar context, so their one cross-year week may read `28 Dec – 3 Jan`.
