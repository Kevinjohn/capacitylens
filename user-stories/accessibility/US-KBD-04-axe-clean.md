...
2. Switch the scheme to **dark** (OS setting or DevTools _Emulate prefers-color-scheme:
   dark_), reload **Schedule**, and run the scan again — still no serious/critical
   violations.
