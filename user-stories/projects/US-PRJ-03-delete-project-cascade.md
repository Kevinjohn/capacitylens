...
## How (end-to-end)
**Precondition:** Seeded app open; click **Projects** in the sidebar (`/projects`). **Project Lightning** has phases (*Discovery*, *Build*), tasks (*Wireframes*, *Visual Design*, *CMS Review*) and allocations; the **Senior Designer** placeholder (`r-ph-designer`) is bound to it.
...
4. Visit **Tasks**, **Resources**, and the **Schedule** (`/`, **Jump to date** → `2026-06-01`) to inspect the result.
...
- ✅ After confirming, **Project Lightning** is gone from Projects; its phases (*Discovery*, *Build*) are gone; its tasks (*Wireframes*, *Visual Design*, *CMS Review*) are gone from Tasks; its allocation bars are gone from the schedule.
...
- ✅ Pressing **⌘Z** restores the project, its phases, tasks and allocations, and re-binds the **Senior Designer** placeholder to it.
