# US-RES-07 — Employment type (no roster badge)
...
captured. The standing product decision is that employment type does not add another badge to the
already dense roster or schedule; external suppliers remain a separate resource kind.
