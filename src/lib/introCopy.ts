// PLACEHOLDER COPY — pending human edit. Verbatim from floaty-copy.md; do NOT rewrite/invent
// positioning. A human edits this wording before launch; the post-login IntroPage is the only
// consumer. Mirrors the single-source pattern of `externalCopy.ts` so the copy lives in one place.
//
...
// dangerouslySetInnerHTML). Verbatim means byte-for-byte: floaty-copy.md uses STRAIGHT ASCII
// apostrophes (0x27) in "who's", "won't", "people's" — keep them straight, not curly. Preserve the
// em-dash "—" exactly as below.
...
/** The page heading. */
export const INTRO_HEADING = 'Welcome to Floaty'
