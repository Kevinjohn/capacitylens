...
describe("domainErrorMessage", () => {
  ...
  const fixedMessageCases: Array<[DomainErrorCode, string]> = [
    ...
    ["activity_project_forbidden", "An internal or cross-project activity cannot belong to a project."],
    ["activity_phase_forbidden", "An internal or cross-project activity cannot belong to a phase."],
