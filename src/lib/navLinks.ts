 ...
 * sites in AppShell) rather than at module load. That matters for i18n (P1.5.2): `LINKS` is
 ...
 * next render.
 */
export type NavLinkDef = [to: string, label: () => string, icon: IconName]
