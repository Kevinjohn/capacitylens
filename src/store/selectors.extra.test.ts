...
const data: AppData = {
  ...
  phases: [{ id: 'ph1', createdAt: 't', updatedAt: 't', name: 'Disc', projectId: 'p1' }],
  tasks: [{ id: 't1', createdAt: 't', updatedAt: 't', name: 'T1', projectId: 'p1' }],
  resources: [
    { id: 'r1', createdAt: 't', updatedAt: 't', kind: 'person', name: 'A', role: 'Dev', employmentType: 'permanent', workingHoursPerDay: 8, workingDays: [1], color: '#4' },
  ],
  allocations: [
