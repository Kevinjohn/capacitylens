...
export const projectsForClient = (data: AppData, clientId: ID) => data.projects.filter((p) => p.clientId === clientId);

export const phasesForProject = (data: AppData, projectId: ID) => data.phases.filter((p) => p.projectId === projectId);
