# Google Sign in with Google button provenance

These are Google's official pre-approved rendered Sign in with Google button assets. The
rendered PNGs include Google's current Google Sans Medium text treatment and preserve the
official logo proportions, so CapacityLens does not fetch fonts or other third-party assets at
runtime.
