...
// Local shadcn deviation: shortcut guards prevent Cmd/Ctrl+B from overriding text entry or open
// modals; cookie persistence is omitted because state is device-local; caller className/style
// overrides propagate consistently through the desktop and mobile shells.
...
function SidebarProviderShell({
  ...
  props: Omit<React.ComponentProps<"div">, "className" | "style" | "children">;
...
function DesktopSidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      <DesktopSidebarGap variant={variant} />
      <div
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-primary data-[active=true]:font-medium data-[active=true]:text-sidebar-primary-foreground data-[active=true]:hover:bg-sidebar-primary data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
