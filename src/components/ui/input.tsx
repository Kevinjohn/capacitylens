...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      type={type}
      data-slot="input"
      // CapacityLens edits to the stock shadcn base: dropped `bg-transparent`/`dark:bg-input/30`
      // (the field wrappers supply capacitylens's own bg-surface — opaque in BOTH themes — and
      ...
      // invalid visual is a SINGLE capacitylens danger ring (fieldAccent's border-danger), not two
