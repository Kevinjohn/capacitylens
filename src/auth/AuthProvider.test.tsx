...
// P3.3: the auth boundary's three behaviours. Local mode is a pass-through that performs
// NO fetch at all; server mode + authMode 'off' renders the app after one /api/auth/me
// check; a 401 walls everything off behind the LoginScreen. apiConfig freezes its env at
// import, so each case stubs the env, resets the module registry, and re-imports —
