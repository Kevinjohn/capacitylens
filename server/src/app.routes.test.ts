...
const EXPECTED_OFF_ROUTES = [
  ...
  "GET /api/accounts/:accountId/resource-avatars",
  "HEAD /api/accounts/:accountId/resource-avatars",
  "PUT /api/accounts/:accountId/members/:userId/resource-link",
  "DELETE /api/accounts/:accountId/members/:userId/resource-link",
  "DELETE /api/accounts/:accountId/members/:userId/resource-link-exception",
  ...
  "POST /api/accounts/:accountId/ownership-transfer",
  "POST /api/accounts/:accountId/ownership-transfer/:requestId/accept",
  "POST /api/accounts/:accountId/ownership-transfer/:requestId/withdraw",
  "POST /api/accounts/:accountId/ownership-transfer/:requestId/decline",
  "POST /api/accounts/:accountId/ownership-transfer/:requestId/complete",
  "DELETE /api/accounts/:accountId/ownership-transfer/:requestId",
