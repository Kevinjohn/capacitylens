...
The v42 pair was generated by the unreleased v42 working tree from copies of the sanitised v34 pair with
Node 24.19.0 and pnpm 11.4.0, using `pnpm --dir server fixtures:database 34 42`. The fixtures include
the optional `resources.avatarUrl` column and passed `quick_check` and `foreign_key_check`:
