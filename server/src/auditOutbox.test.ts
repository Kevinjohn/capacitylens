...
describe("durable audit outbox", () => {
  ...
  describe("payload validation", () => {
    ...
    describe("invalid union semantics", () => {
      it.each([
...
describe("audit recovery corruption surfacing", () => {
  ...
  describe("parseable lines", () => {
    describe("missing audit id", () => {
