...
async function readSnapshotCount(page: Page) {
...
test("Cancel is a no-op; confirm clears owned device data, preserves unrelated data, and reloads", async ({ page }) => {
  ...
  expect(await readSnapshotCount(page)).toBe(0);
