...
- Make the managed-VPS deployment examples stop on build failures, limit Supervisor privileges to
  ...
  (#921, #933, #936).
- Make Overview Bar mode's unavailable cells lighter and separate each week block for easier
  scanning without changing the table's density or alignment (#963).
...
- Production builds now contain physical entry documents for every fixed application route, so
  ...
  the application Not Found screen while preserving genuine asset, file and API 404s (#216).
...
[0.40.6-alpha.1]: https://github.com/Kevinjohn/capacitylens/compare/v0.40.5-alpha.1...v0.40.6-alpha.1
[0.40.5-alpha.1]: https://github.com/Kevinjohn/capacitylens/compare/v0.40.4-alpha.1...v0.40.5-alpha.1
[0.40.4-alpha.1]: https://github.com/Kevinjohn/capacitylens/compare/v0.40.3-alpha.1...v0.40.4-alpha.1
