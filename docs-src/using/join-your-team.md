...
![Placeholder: Invitation preview with the company, invited email and sign-in choices](https://placehold.co/686x385?text=Invitation+preview%3A+company+email+and+sign-in+choices)
...
![Placeholder: Signed-in invitation with the company and acceptance action](https://placehold.co/686x385?text=Signed-in+invitation%3A+company+and+acceptance+action)
