...
| Ownership transfer request | company, initiator and nominee ids, workflow state, deadline                       | SQLite over TLS                                                            | a live request expires seven days after it is made; a terminal request is retained for a year and then swept; account erasure deletes them; no name or email is ever copied into the row |
