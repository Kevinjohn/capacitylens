...
export default defineConfig({
  ...
  base: '/capacitylens/',
  cleanUrls: true,
  // The built site is a committed artifact at the repo root, not an ignored
  // .vitepress/dist — rebuild with `pnpm run docs:build` after editing docs.
  outDir: '../site',
  lastUpdated: true,
  ...
  // Internal records that live in docs/ but are not part of the site.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: 'Screenshots are captured from the running app — see docs/STYLE.md in the repository.',
    },
  },
})
